...
class WorldMapPage extends React.Component {
    ...
    handleSwipeLeft(navigator) {
        navigator.pushPage({ component: News, key: 'NEWS_PAGE' });
        this.setState({
            visible: false
        });
    }
    handleSwipeRight(navigator) {
    ...
    render() {
        ...
        return (
            <Page className="world-map-page-container background" renderBottomToolbar={() => <NavBar title='Onsen Weather' navigator={navigator} />}>
                <div>
                    <Swipeable
                        style={{ width: "100%", height: "100%" }}
                        onSwipedRight={() => this.handleSwipeRight(navigator)}
                        onSwipedLeft={() => this.handleSwipeLeft(navigator)}
                    >
                        ...
                        <div className="world-map-container">
                            ...
                            <div className="map-container" id="am-charts-world-map">
                                ...
                                <div className="world-map-dialog">
                                    <div className="search-container">
                                        <form className="search-form">
                                            <input id="search-world-map" className="search-input" type="text" placeholder="Qual o país que procura?"
                                                name="search"></input>
                                        </form>
                                    </div>
